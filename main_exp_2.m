...
cbardata = './input/yang_colorbar.dat';
img_crop = './input/yang_figure_6b_crop.bmp';
...
user_data = false;
[sampled, N_vis, N_exc] = process_img('yang_', X_range, Y_range, ...
...
if user_data
    filename = 'yang_figure_6b_manual.png';
else
    filename = 'yang_figure_6b_auto.png';
end
